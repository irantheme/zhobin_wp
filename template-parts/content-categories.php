...
<div class="content-heading">
  <h2>
    ...
    if (is_archive()) {
      ...
      echo 'نتایج یافت شده';
    } else if (get_option('irantheme_content_heading')) {
      echo __(get_option('irantheme_content_heading'));
    }
    ?>
  </h2>
  <p>
    ...
    } else if (get_option('irantheme_content_description')) {
      echo __(get_option('irantheme_content_description'));
    }
    ?>
  </p>
</div>
